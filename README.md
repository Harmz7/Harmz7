...
Azure-certified IT professional with over 6 years of experience across enterprise infrastructure, cloud engineering, and systems administration[cite: 1]. Experienced in designing automated deployment pipelines, managing multi-tenant Azure environments, and implementing identity and access controls[cite: 1].
...
* **[azure-gitops-pipeline](https://github.com/Harmz7/azure-gitops-pipeline):** Automated deployment pipeline built with GitHub Actions, Terraform, Ansible, and Docker Compose on Azure.
* **[devops-learning-path](https://github.com/Harmz7/devops-learning-path):** Azure DevOps infrastructure automation and configuration labs.
